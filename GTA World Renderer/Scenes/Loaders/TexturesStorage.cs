...
namespace GTAWorldRenderer.Scenes.Loaders
{
   ...
   class TexturesStorage
   {
      ...
      /// <summary>
      /// Сбрасывает состояние хранилища текстур.
      /// Удаляет из памяти все загруженные текстуры и все архивы.
      /// Полезно использовать после того, как сцены загружка завершена, чтобы 
